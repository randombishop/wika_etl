...
const testDataArray = [
  {
    ...
    meta: {
      ...
      description:
        "Blockchain to manage URL Ownership registry and reward authors with Wika tokens.<head />",
  ...
  },
  {
    ...
    meta: {
      ...
      description:
        "Contribute to randombishop/wika_etl development by creating an account on GitHub.",
